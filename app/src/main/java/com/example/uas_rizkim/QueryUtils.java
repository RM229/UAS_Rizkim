...
public class QueryUtils {
    ...
    public static ArrayList<MovieDetails> extractMovieDetails() {
        ...
        try {
            ...
            for (int i = 1; i < jsonArray.length(); i++) {
                ...
                MovieDetails movieDetails = new MovieDetails(rating, product, "Rp. " + price);
